...
#Compile C code
gcc -ffreestanding -nostdlib -nostdinc -fno-builtin -fno-stack-protector -fno-asynchronous-unwind-tables -c os.c keyboard.c system.c stdio.c commandline.c string.c memory.c

#Link them together
ld -Tlinker.ld -o os.img os_a.o os.o keyboard.o system.o stdio.o commandline.o string.o memory.o dummy_end_section.o
